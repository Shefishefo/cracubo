...
tehpodderjka.add(InlineKeyboardButton('Тех. поддержка', url='https://t.me/Sofa_sex'))
tehpodderjka.add(InlineKeyboardButton(text="Пополнить баланс",callback_data="pay"))

partnerss = InlineKeyboardMarkup()
partnerss.add(InlineKeyboardButton('Заказать рекламу', url='https://t.me/Sofa_sex'))
partnerss.add(InlineKeyboardButton('Канал', url='https://t.me/Sofa_sex'))
